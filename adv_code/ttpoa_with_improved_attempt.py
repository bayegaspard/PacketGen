...
# Define the plotting functions (Ensure these are defined at the global scope)
def plot_confusion_matrices(y_true, y_pred_orig, y_pred_adv, classes, step, filename, data_type='Adversarial'):
    ...
    axes[1].set_title(f'{data_type} Data - Step {step}')
...
def plot_metric_comparisons(metrics, steps):
    """
    Plots F1 score, recall, and precision comparisons between:
    - Clean vs. Adversarial
    - Clean vs. TTOPA
    - Adversarial vs. TTOPA
    """
    # Extract metrics
    ...
    clean_precision = [metrics["original"]["precision"][0]] * len(steps)
    adv_precision = metrics["adversarial"]["precision"]
    ttpa_precision = metrics["ttpa"]["precision"]

    clean_recall = [metrics["original"]["recall"][0]] * len(steps)
    adv_recall = metrics["adversarial"]["recall"]
    ttpa_recall = metrics["ttpa"]["recall"]
    ...
    plt.ylabel("F1 Score")
    plt.title("F1 Score: Clean vs. Adversarial")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/f1_clean_vs_adv.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Time Steps")
    plt.ylabel("F1 Score")
    plt.title("F1 Score: Clean vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/f1_clean_vs_ttpa.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Time Steps")
    plt.ylabel("F1 Score")
    plt.title("F1 Score: Adversarial vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/f1_adv_vs_ttpa.png", dpi=300)
    plt.close()

    # Plot Precision Comparisons
    # Clean vs. Adversarial
    plt.figure(figsize=(12, 8))
    plt.plot(steps, clean_precision, label="Precision (Clean)", marker='s', color='blue')
    plt.plot(steps, adv_precision, label="Precision (Adversarial)", marker='s', color='red')
    plt.xlabel("Time Steps")
    plt.ylabel("Precision")
    plt.title("Precision: Clean vs. Adversarial")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/precision_clean_vs_adv.png", dpi=300)
    plt.close()

    # Clean vs. TTOPA
    plt.figure(figsize=(12, 8))
    plt.plot(steps, clean_precision, label="Precision (Clean)", marker='s', color='blue')
    plt.plot(steps, ttpa_precision, label="Precision (TTOPA)", marker='s', color='green')
    plt.xlabel("Time Steps")
    plt.ylabel("Precision")
    plt.title("Precision: Clean vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/precision_clean_vs_ttpa.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Time Steps")
    plt.ylabel("Precision")
    plt.title("Precision: Adversarial vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/precision_adv_vs_ttpa.png", dpi=300)
    plt.close()

    # Plot Recall Comparisons
    # Clean vs. Adversarial
    plt.figure(figsize=(12, 8))
    plt.plot(steps, clean_recall, label="Recall (Clean)", marker='^', color='blue')
    plt.plot(steps, adv_recall, label="Recall (Adversarial)", marker='^', color='red')
    plt.xlabel("Time Steps")
    plt.ylabel("Recall")
    plt.title("Recall: Clean vs. Adversarial")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/recall_clean_vs_adv.png", dpi=300)
    plt.close()

    # Clean vs. TTOPA
    plt.figure(figsize=(12, 8))
    plt.plot(steps, clean_recall, label="Recall (Clean)", marker='^', color='blue')
    plt.plot(steps, ttpa_recall, label="Recall (TTOPA)", marker='^', color='green')
    plt.xlabel("Time Steps")
    plt.ylabel("Recall")
    plt.title("Recall: Clean vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/recall_clean_vs_ttpa.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Time Steps")
    plt.ylabel("Recall")
    plt.title("Recall: Adversarial vs. TTOPA")
    plt.legend()
    plt.grid(True)
    plt.savefig("results/recall_adv_vs_ttpa.png", dpi=300)
    plt.close()

    print("Metric comparison plots saved in the 'results' directory.")
...
for step in incremental_steps:
    ...
    plot_confusion_matrices(
        ...
        step, f'results/confusion_matrices_step_{step}.png', data_type='Adversarial'
    )

    plot_confusion_matrices(
        y_test, y_pred, y_ttap_pred, label_encoder.classes_,
        step, f'results/confusion_matrices_ttap_step_{step}.png', data_type='TTOPA'
    )
